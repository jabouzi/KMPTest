...
import theme.RealmColor
import theme.myTypography
...
@Composable
fun CounterApp(vm: BirdsViewModel) {
    Surface(color = RealmColor.Elephant) {
        Column {
            Text(
                text = "أو أعلى الحرف المراد إمالته كما في المثال التالي" + englishNumberToArabicNumber(286),
